...
(function($) {
 ...
 function makeTimer() {
	   ...
	   var endTime = new Date("21 May 2019 9:56:00 GMT+01:00");			
	   ...
	   $("#days").html(days + "<span>Global Score</span>");
	   $("#hours").html(hours + "<span>Game Score</span>");
...
g.setState = function( name ) {
   console.log("inside setstate",g.state)
 if( g.state ) {
...
StatePlay.prototype.exit = function() {
   console.lof("exit funcuton called")
